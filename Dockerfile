...
ARG SSL=true
#Monitoring is disabled because it is not compatible with features the application is using.
#To enable monitoring, you must be using compatible features and set the monitoring value to true in this file, and also in the values.yaml for the chart.
